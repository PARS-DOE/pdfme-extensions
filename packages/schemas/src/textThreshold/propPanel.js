...
import { DEFAULT_FONT_SIZE, DEFAULT_ALIGNMENT, DEFAULT_VERTICAL_ALIGNMENT, DEFAULT_CHARACTER_SPACING, DEFAULT_LINE_HEIGHT, DEFAULT_FONT_COLOR, DYNAMIC_FIT_VERTICAL, DYNAMIC_FIT_HORIZONTAL, DEFAULT_DYNAMIC_FIT, DEFAULT_DYNAMIC_MIN_FONT_SIZE, DEFAULT_DYNAMIC_MAX_FONT_SIZE, DEFAULT_THRESHOLD, DEFAULT_THRESHOLD_BACKGROUND_COLOR, } from './constants.js';
    ...
    schema: ({ options, activeSchema, i18n }) => {
        ...
        const textSchema = {
            ...
            thresholdBackgroundColor: {
                title: 'Threshold Background Color',
                type: 'string',
                widget: 'color',
                props: {
                    disabledAlpha: true,
