...
import { calculateDynamicFontSize, heightOfFontAtSize, getFontDescentInPt, getFontKitFont, widthOfTextAtSize, splitTextToSize, isAboveThreshold, } from './helper.js';
...
export const pdfRender = async (arg) => {
    ...
    if (schema.threshold !== undefined && schema.thresholdBackgroundColor) {
        const isAboveThresholdValue = isAboveThreshold(value, schema.threshold, variables, schema.thresholdField);
